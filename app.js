...
function actualizarInfoCancion() {
    tituloCancion.textContent = canciones[indiceCancionesActual].titulo;
    nombreArtista.textContent = canciones[indiceCancionesActual].nombre;
    cancion.src = canciones[indiceCancionesActual].fuente;
